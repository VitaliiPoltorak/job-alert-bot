...
Напиши короткое сопроводительное письмо на русском языке (2-4 предложения),
от первого лица, без приветствий и подписи типа "С уважением" — только текст письма.
